...
// end, day, free }] (start/end = ISO dateTime; day = YYYY-MM-DD for all-day
// events; free = marked "free"/transparent, i.e. not busy). Feeds
...
async function listEvents(calendarId, timeMinIso, timeMaxIso) {
  ...
  do {
    const qs = new URLSearchParams({
      ...
      fields: "items(id,summary,description,start,end,transparency),nextPageToken",
    });
